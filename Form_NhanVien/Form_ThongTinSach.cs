...
{
    public partial class Form_ThongTinSach : Form
    {
        ...
        {
            Sidebar_Transition(ref menuExpand, panel_XoaSach, timer_ChinhSuaSachTransition);
        }
        ...
        {
            menuExpand = false;
            StartTimer(timer_ChinhSuaSachTransition); //Start Timer của CSTK
            if (panel_XoaSach.Height == 195) StopTimer(timer_ChinhSuaSachTransition);
            doubleClickCount++;
        ...
        {
            menuExpand = true;
            StartTimer(timer_ChinhSuaSachTransition); //Start Timer của panel_XoaSach
            numberRecord = 10;
            LoadData();
            doubleClickCount = 0;
        }
        ...
        {
            Form_ThemXoaSach formThemXoaSach = new Form_ThemXoaSach();
            formThemXoaSach.Show();
        }
    }
}
